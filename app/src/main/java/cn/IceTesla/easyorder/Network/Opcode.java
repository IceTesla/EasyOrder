...
public class Opcode {
	...
	public final static String getMenu = "1700";
	public final static String checkTable = "1800";
	public final static String checkTableSucc = "1801";
	public final static String checkTableFail = "1802";
}
